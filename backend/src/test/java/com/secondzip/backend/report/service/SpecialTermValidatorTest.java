...
class SpecialTermValidatorTest {
    ...
    void rejectsTooManyTerms() {
        List<SpecialTermResultDTO> terms = List.of(
                ...
                new SpecialTermResultDTO("특약4", "내용4"),
                new SpecialTermResultDTO("특약5", "내용5"),
                new SpecialTermResultDTO("특약6", "내용6")
        );
    ...
    void rejectsTooLongTitle() {
        List<SpecialTermResultDTO> terms = List.of(
                new SpecialTermResultDTO("가".repeat(51), "내용1"),
                new SpecialTermResultDTO("특약2", "내용2"),
                new SpecialTermResultDTO("특약3", "내용3")
        );
    ...
    void rejectsTooLongContent() {
        List<SpecialTermResultDTO> terms = List.of(
                new SpecialTermResultDTO("특약1", "가".repeat(201)),
                new SpecialTermResultDTO("특약2", "내용2"),
                new SpecialTermResultDTO("특약3", "내용3")
        );
