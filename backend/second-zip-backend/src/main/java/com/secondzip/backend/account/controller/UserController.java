...
public class UserController {
    ...
    public ResponseEntity<AccountResponseDTO> updateCharacter(@AuthenticationPrincipal Long accountId, @RequestBody UpdateCharacterDTO updateDTO) {
    ...
    @DeleteMapping
    public ResponseEntity<MessageResponseDTO> withdraw(@AuthenticationPrincipal Long accountId, @RequestBody WithdrawAccountDTO withdrawDTO, HttpServletRequest request) {
    ...
    public ResponseEntity<MessageResponseDTO> updatePassword(@AuthenticationPrincipal Long accountId, @RequestBody UpdatePasswordDTO updatePasswordDTO, HttpServletRequest request) {
        String accessToken = jwtTokenResolver.resolveAccessToken(request);
